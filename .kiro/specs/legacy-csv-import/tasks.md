...
- [x] 1. eventsテーブルのeventSeriesIdをオプショナルに変更する
...
- [x] 2. レガシーCSV専用パーサーを実装する
- [x] 2.1 (P) 基本的なCSVパース機能を実装する
...
- [x] 4. データベースへの一括登録サービスを実装する
- [x] 4.1 イベント・サークル・アーティスト登録を実装する
...
- [x] 5. インポートAPIエンドポイントを実装する
- [x] 5.1 プレビューエンドポイントを実装する
...
- [x] 6. インポートウィザードUIを実装する
- [x] 6.1 (P) CSVアップロードステップを実装する
...
- [x] 8. テストを実装する
- [x] 8.1 (P) パーサーとマッチャーのユニットテストを実装する
