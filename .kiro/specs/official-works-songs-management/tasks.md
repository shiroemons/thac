...
- [ ] 1.4 データベースマイグレーションを実行する
  - マイグレーションファイルを生成
  - スキーマをデータベースに適用
  - 作成されたテーブルを確認
  - _Requirements: 1.1, 2.1_

- [ ] 2. 公式作品のCRUD APIを実装する
- [ ] 2.1 公式作品の一覧取得・個別取得エンドポイントを実装する
  - ページネーション付き一覧取得機能を実装
  - 作品名での部分一致検索を実装
  - カテゴリによるフィルタリングを実装
...
- [ ] 3. 公式楽曲のCRUD APIを実装する
- [ ] 3.1 公式楽曲の一覧取得・個別取得エンドポイントを実装する
  - ページネーション付き一覧取得機能を実装
  - 楽曲名での部分一致検索を実装
  - 作品によるフィルタリングを実装
  - 主題区分によるフィルタリングを実装
...
- [ ] 9. ダッシュボード統合
- [ ] 9.1 統計APIを拡張して公式作品・楽曲の件数を返す
  - 統計APIに公式作品・楽曲のカウントクエリを追加
  - 統計データ型に公式作品・楽曲フィールドを追加
  - 並列でカウントを取得するよう実装
  - _Requirements: 9.4_

- [ ] 9.2 ダッシュボードに公式作品・楽曲の統計カードを追加する
  - 公式作品の総件数を表示するカードを追加
  - 公式楽曲の総件数を表示するカードを追加
