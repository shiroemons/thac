...
- [ ] 2.5 サークル関連APIをreleasesルーターに統合
  - ネストリソースパターン（/:releaseId/circles）でマウント
  - AdminContext認証ミドルウェア適用
  - _Requirements: 6.1, 6.2, 6.3, 6.4_

- [ ] 3. フロントエンドAPIクライアント追加
- [ ] 3.1 (P) releaseCirclesApiの実装
  - list: 関連サークル一覧取得
  - add: サークル関連付け追加
