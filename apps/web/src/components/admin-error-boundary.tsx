...
import { AlertTriangle, Clock, LayoutDashboard, RefreshCw } from "lucide-react";
...
/**
 * 管理画面用エラーコンポーネント
 * 管理画面ルートのerrorComponentとして使用
 */
export function AdminErrorBoundary({ error }: ErrorComponentProps) {
	const router = useRouter();
	const isTimeout = isTimeoutError(error);
	const isSSR = isSSRError(error);

	// エラーログ出力
	console.error(`[Admin ${isSSR ? "SSR" : "Client"}] Error:`, {
